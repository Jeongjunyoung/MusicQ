...
public class DBHelper {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            ...
            sqLiteDatabase.execSQL("create table list_music(music_id integer primary key autoincrement, " +
                    "list_id integer, music_title text, " +
                    "music_artist text, constraint list_id_fk foreign key(list_id) references playlist(_id))");
        }
